				...
				if description and author and isbn and coverLargeUrl:
					...
					if len(reviewList) >= 3:
						self.book_list.append( {"BOOK_NM":book_nm,"BOOK_IMG_L_URL":coverLargeUrl,
											...
											"REVIEW_LIST":reviewList,"BOOK_DESC":description,"BOOK_DESC2":description2,"BOOK_DESC3":description3,"RW_CNT":rwcnt
											})
					else:
						self.ad.df_orderInsert(isbn, 'N')
...
# 	ad = ask_db.AskDb()
# 	kbb = kyobo(ad,naverApi.NaverApi())
